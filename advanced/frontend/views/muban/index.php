    ...
    <div class="header">
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						  <ul class="nav navbar-nav">
							<li class="active"><a href="?r=muban/index" data-hover="Home">Home</a></li>
							<li><a href="?r=muban/about" data-hover="About">关于</a></li>
							<li><a data-hover="Restaurant" href="?r=muban/restaurant">餐饮</a></li>
							<li><a data-hover="Gallery" href="?r=muban/gallery">画廊</a></li>
							<li><a data-hover="Rooms" href="?r=muban/rooms">住宿</a></li>
							  <li><a href="?r=muban/codes" data-hover="Codes">崔陕江</a></li>
							 <li><a data-hover="Contact" href="?r=muban/houtai">公司后台（闲人免进）</a></li>
						  </ul>
						</div><!-- /.navbar-collapse -->
					</div><!-- /.container-fluid -->
				</nav>
		...
		<div class="content">
			...
			<div class="resort-section">
				<div class="container">
					<h3 class="tittle">度假村最新<span>优惠</span></h3>
					<div class="resort-grids">
				<!-- start content_slider -->h
			...
			<div class="superlist">
				<div class="container">
					<h3 class="tittle">来到我们这里是你最美丽的选择</h3>
					<center><p class="wel text">您的快乐出行就是我们需要做到的一切，感谢您对于我们的信任</p></center>
						...
						<div class="col-md-4 super-grid1">
							<div class="super-top">
								<img src="images/s4.jpg" class="img-responsive gray" alt=""/>
									<h4>豪华套房</h4>
									<center><p>我们的公司成立于2008年</p></center>
							</div>
						</div>
							<div class="clearfix"></div>
					</div>
					...
					<div class="testimonial-grids">
						<div class="col-md-6 testimonial-grid">
							...
							<div class="testimonial-right">
								...
								<div class="clearfix"></div>
								<center><p>相信自己，自己是最快乐的</p></center>
