												...
												<div class="widget-body">
													<div class="widget-main">
														...
														<div>
															...
															<textarea id="form-field-11" class="autosize-transition form-control" style="overflow: hidden; overflow-wrap: break-word; resize: horizontal; height: 69px;"></textarea>
														</div>
													</div>
												</div>
											</div>
													...
													<div class="widget-main">
														...
														<div>
															...
															<div class="input-group">
																...
																<input class="form-control input-mask-phone" id="form-field-mask-2" type="text">
															</div>
														</div>
														...
														<div>
															...
															<div class="input-group">
																<input class="form-control input-mask-product" id="form-field-mask-3" type="text">
																<span class="input-group-addon">
																	<i class="icon-key"></i>
																</span>
															</div>
													...
													<div class="widget-main">
														...
														<div>
															...
															<select class="width-80 chosen-select" id="form-field-select-3" data-placeholder="Choose a Country..." style="display: none;">
																...
																<option value="WI">Wisconsin</option>
																<option value="WY">Wyoming</option>
															</select><div class="chosen-container chosen-container-single" style="width: 305px;" title="" id="form_field_select_3_chosen"><a class="chosen-single" tabindex="-1"><span>&nbsp;</span><div><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input autocomplete="off" type="text"></div><ul class="chosen-results"></ul></div></div>
														</div>
														...
														<div>
															...
															<select multiple="" class="width-80 chosen-select" id="form-field-select-4" data-placeholder="Choose a Country..." style="display: none;">
																...
																<option value="WI">Wisconsin</option>
																<option value="WY">Wyoming</option>
															</select><div class="chosen-container chosen-container-multi" style="width: 305px;" title="" id="form_field_select_4_chosen"><ul class="chosen-choices"><li class="search-field"><input value="Choose a Country..." class="default" autocomplete="off" style="width: 140px;" type="text"></li></ul><div class="chosen-drop"><ul class="chosen-results"></ul></div></div>
														</div>
													</div>
												</div>
											</div>
									...
									<div class="row">
										...
										<div class="col-xs-12 col-sm-6">
											<div class="control-group">
												...
												<div class="radio">
													<label>
														<input disabled="" name="form-field-radio" class="ace" type="radio">
														<span class="lbl"> disabled</span>
													</label>
												</div>
											</div>
									...
									<div class="row">
										...
										<div class="col-sm-4">
											<div class="widget-box">
												...
												<div class="widget-body">
													<div class="widget-main">
														<div class="ace-spinner" style="width: 70px;"><div class="input-group"><input class="input-mini spinner-input form-control" id="spinner1" maxlength="3" type="text"><div class="spinner-buttons input-group-btn btn-group-vertical">							<button type="button" class="btn spinner-up btn-xs btn-info">								<i class="icon-chevron-up"></i>							</button>							<button type="button" class="btn spinner-down btn-xs btn-info">								<i class="icon-chevron-down"></i>							</button>						</div></div></div>
														<div class="space-6"></div>

														<div class="ace-spinner touch-spinner" style="width: 140px;"><div class="input-group"><input class="input-mini spinner-input form-control" id="spinner2" maxlength="5" type="text"><div class="spinner-buttons input-group-btn">							<button type="button" class="btn spinner-up btn-xs ">								<i class="icon-caret-up"></i>							</button>							<button type="button" class="btn spinner-down btn-xs ">								<i class="icon-caret-down"></i>							</button>						</div></div></div>
														<div class="space-6"></div>

														<div class="ace-spinner touch-spinner" style="width: 100px;"><div class="input-group"><div class="spinner-buttons input-group-btn">							<button type="button" class="btn spinner-down btn-xs btn-danger">								<i class="icon-minus smaller-75"></i>							</button>						</div><input class="input-mini spinner-input form-control" id="spinner3" maxlength="3" type="text"><div class="spinner-buttons input-group-btn">							<button type="button" class="btn spinner-up btn-xs btn-success">								<i class="icon-plus smaller-75"></i>							</button>						</div></div></div>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="widget-box">
												...
												<div class="widget-body">
													<div class="widget-main">
														...
														<div class="row">
															<div class="col-xs-8 col-sm-11">
																<div class="input-group">
																	...
																	<input class="form-control" name="date-range-picker" id="id-date-range-picker-1" type="text">
																</div>
															</div>
														</div>
														...
														<div class="input-group bootstrap-timepicker"><div class="bootstrap-timepicker-widget dropdown-menu"><table><tbody><tr><td><a href="#" data-action="incrementHour"><i class="icon-chevron-up"></i></a></td><td class="separator">&nbsp;</td><td><a href="#" data-action="incrementMinute"><i class="icon-chevron-up"></i></a></td><td class="separator">&nbsp;</td><td><a href="#" data-action="incrementSecond"><i class="icon-chevron-up"></i></a></td></tr><tr><td><input name="hour" class="bootstrap-timepicker-hour" maxlength="2" type="text"></td> <td class="separator">:</td><td><input name="minute" class="bootstrap-timepicker-minute" maxlength="2" type="text"></td> <td class="separator">:</td><td><input name="second" class="bootstrap-timepicker-second" maxlength="2" type="text"></td></tr><tr><td><a href="#" data-action="decrementHour"><i class="icon-chevron-down"></i></a></td><td class="separator"></td><td><a href="#" data-action="decrementMinute"><i class="icon-chevron-down"></i></a></td><td class="separator">&nbsp;</td><td><a href="#" data-action="decrementSecond"><i class="icon-chevron-down"></i></a></td></tr></tbody></table></div>
													...
													<div class="widget-main">
														...
														<div class="control-group">
															<div class="bootstrap-colorpicker">
																<input id="colorpicker1" class="input-small" type="text">
															</div>
														</div>
														...
														<div class="control-group">
															<div class="row">
																<div class="col-xs-6 center">
																	<div class="knob-container inline">
																		<div style="display:inline;width:80px;height:80px;"><canvas width="80" height="80"></canvas><input class="input-small knob" value="15" data-min="0" data-max="100" data-step="10" data-width="80" data-height="80" data-thickness=".2" style="width: 44px; height: 26px; position: absolute; vertical-align: middle; margin-top: 26px; margin-left: -62px; border: 0px none; background: rgba(0, 0, 0, 0) none repeat scroll 0% 0%; font: bold 16px Arial; text-align: center; color: rgb(135, 206, 235); padding: 0px;" type="text"></div>
																	</div>
																</div>

																<div class="col-xs-6  center">
																	<div class="knob-container inline">
																		<div style="display:inline;width:80px;height:80px;"><canvas width="80" height="80"></canvas><input class="input-small knob" value="41" data-min="0" data-max="100" data-width="80" data-height="80" data-thickness=".2" data-fgcolor="#87B87F" data-displayprevious="true" data-anglearc="250" data-angleoffset="-125" style="width: 44px; height: 26px; position: absolute; vertical-align: middle; margin-top: 26px; margin-left: -62px; border: 0px none; background: rgba(0, 0, 0, 0) none repeat scroll 0% 0%; font: bold 16px Arial; text-align: center; color: rgb(135, 184, 127); padding: 0px;" type="text"></div>
																	</div>
																</div>
															</div>
															...
															<div class="row">
																<div class="col-xs-12 center">
																	<div class="knob-container inline">
																		<div style="display:inline;width:150px;height:150px;"><canvas width="150" height="150"></canvas><input class="input-small knob" data-min="0" data-max="10" data-width="150" data-height="150" data-thickness=".2" data-fgcolor="#B8877F" data-angleoffset="90" data-cursor="true" style="width: 79px; height: 50px; position: absolute; vertical-align: middle; margin-top: 50px; margin-left: -114px; border: 0px none; background: rgba(0, 0, 0, 0) none repeat scroll 0% 0%; font: bold 37px Arial; text-align: center; color: rgb(184, 135, 127); padding: 0px;" type="text"></div>
																	</div>
																</div>
															</div>
														</div>
											...
											<div class="widget-body">
												<div class="widget-main">
													<form class="form-inline">
														<input class="input-small" placeholder="Username" type="text">
													...
													<form class="form-search">
														<div class="row">
															<div class="col-xs-12 col-sm-8">
																<div class="input-group">
																	<input class="form-control search-query" placeholder="Type your query" type="text">
																	<span class="input-group-btn">
												...
												<div class="row">
													...
													<div class="col-xs-12 col-sm-7">
														<div class="form-group">
															...
															<div>
																<select class="chosen-select" data-placeholder="Choose a Country..." style="display: none;">
																	...
																	<option value="WI">Wisconsin</option>
																	<option value="WY">Wyoming</option>
																</select><div class="chosen-container chosen-container-single" style="width: 0px;" title=""><a class="chosen-single" tabindex="-1"><span>&nbsp;</span><div><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input autocomplete="off" type="text"></div><ul class="chosen-results"></ul></div></div>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div>
																<input class="input-large" id="form-field-username" placeholder="Username" value="alexdoe" type="text">
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div>
																<input class="input-medium" id="form-field-first" placeholder="First Name" value="Alex" type="text">
																<input class="input-medium" id="form-field-last" placeholder="Last Name" value="Doe" type="text">
															</div>
														</div>
													</div>
												</div>
