								...
								<form id="id-message-form" class="hide form-horizontal message-form  col-xs-12">
									<div class="">
										<div class="form-group">
											...
											<div class="col-sm-9">
												<span class="input-icon">
													<input name="recipient" id="form-field-recipient" data-value="alex@doe.com" value="alex@doe.com" placeholder="Recipient(s)" type="email">
													<i class="icon-user"></i>
												</span>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-6 col-xs-12">
												<div class="input-icon block col-xs-12 no-padding">
													<input maxlength="100" class="col-xs-12" name="subject" id="form-field-subject" placeholder="Subject" type="text">
								...
								<div class="hide message-content" id="id-message-content">
									...
									<div class="message-attachment clearfix">
										...
										<div class="attachment-images pull-right">
											...
											<div>
												<img alt="image 4" src="assets/images/gallery/thumb-4.jpg" width="36">
												<img alt="image 3" src="assets/images/gallery/thumb-3.jpg" width="36">
												<img alt="image 2" src="assets/images/gallery/thumb-2.jpg" width="36">
												<img alt="image 1" src="assets/images/gallery/thumb-1.jpg" width="36">
											</div>
										</div>
									</div>
								</div><!-- /.message-content -->
